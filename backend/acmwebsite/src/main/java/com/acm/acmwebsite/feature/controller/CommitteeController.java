...
public class CommitteeController {
    ...
    @Autowired
    public void setCommitteeService(CommitteService committeeService,SubscriptionService subscriptionService,MessageRepository messageRepository) {
    ...
    //waiting for the new message for calling in Request body
    //message is optional in request
    ...
    @Transactional
    public ResponseEntity<?> changeMessage(@PathVariable Long id, @RequestBody Message message){
        var committee=committeeService.getById(id);
        if(committee==null){
            return ResponseEntity.notFound().build();
        }
    ...
    public ResponseEntity<?> subscribe(@PathVariable Long id,
        ...
        subscriptionService.sendConfirmationEmail(newSubscription,new Message("hello","you have subscribed!"));
        return ResponseEntity.ok().build();
