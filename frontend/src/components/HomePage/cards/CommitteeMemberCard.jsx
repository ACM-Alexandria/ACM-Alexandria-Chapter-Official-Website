const CommitteeMemberCard = ({ member }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 hover:shadow-lg hover:shadow-slate-200/50 dark:hover:shadow-slate-950/40 transition-all duration-300 border border-slate-100 dark:border-slate-700 text-center group mx-auto w-[105px] min-[375px]:w-[120px] min-[425px]:w-[135px] sm:w-40 md:w-48 lg:w-64 p-2.5 min-[375px]:p-3 min-[425px]:p-3.5 sm:p-4 md:p-5 lg:p-6 rounded-2xl sm:rounded-3xl">
      <div className="relative mx-auto rounded-full overflow-hidden bg-slate-50 dark:bg-slate-700 border border-slate-100 dark:border-slate-600 flex items-center justify-center w-12 h-12 min-[375px]:w-14 min-[375px]:h-14 min-[425px]:w-16 min-[425px]:h-16 sm:w-16 sm:h-16 lg:w-20 lg:h-20">
        {imageUrl ? (
          <img
            src={imageUrl}
            alt={name}
      ...
      <p className="text-slate-900 dark:text-slate-100 font-extrabold tracking-tight leading-tight group-hover:text-[#4B98C8] transition-colors mt-2.5 min-[375px]:mt-3 min-[425px]:mt-3.5 sm:mt-4 lg:mt-5 text-[10px] min-[375px]:text-[11px] min-[425px]:text-xs sm:text-xs md:text-sm lg:text-base">
        {name}
      </p>
      <p className="text-slate-500 dark:text-slate-300 font-bold opacity-70 uppercase tracking-[0.15em] mt-0.5 sm:mt-1 text-[8px] min-[375px]:text-[8.5px] min-[425px]:text-[9px] sm:text-[9px] md:text-[9.5px] lg:text-[10px] truncate">
        {member.role}
      </p>
      ...
      {linkedinUrl && (
        <div className="flex lg:hidden justify-center mt-2.5">
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="rounded-full bg-slate-100 dark:bg-slate-700 flex items-center justify-center text-slate-600 dark:text-slate-200 hover:bg-[#0077b5] hover:text-white transition-colors cursor-pointer w-5.5 h-5.5 min-[375px]:w-6 min-[375px]:h-6 min-[425px]:w-7 min-[425px]:h-7 sm:w-7 sm:h-7"
            title="LinkedIn Profile"
          >
