...
const SeasonCard = ({ season, index }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-64 overflow-hidden bg-slate-100 dark:bg-slate-700 shrink-0">
        ...
        {season.imageUrl && !imageError ? (
          ...
          <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#4B98C8]/20 to-[#205E85]/20">
            <FiMic className="text-slate-300 dark:text-slate-500 w-16 h-16 opacity-40 group-hover:rotate-6 transition-transform duration-500" />
          </div>
        )}
      ...
      <div className="p-8 flex flex-col flex-1 items-center text-center">
        <h3 className="text-2xl font-extrabold text-slate-900 dark:text-slate-100 tracking-tight mb-3 group-hover:text-[#4B98C8] transition-colors leading-tight">
          Season {season.seasonNumber}
        </h3>
        
        <p className="text-slate-500 dark:text-slate-300 text-sm leading-relaxed mb-6 font-medium flex-1">
