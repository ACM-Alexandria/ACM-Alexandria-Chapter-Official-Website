            ...
            {loading ? (
              ...
              <div className="space-y-10" style={{ animation: "fadeIn 1s ease 0.3s both" }}>
                ...
                {(program.startDate || program.time) && (
                  <div className="bg-slate-50 dark:bg-slate-800 p-6 rounded-[2rem] border border-slate-100 dark:border-slate-700 flex flex-col sm:flex-row sm:items-center gap-6 group transition-all duration-300 hover:bg-white dark:hover:bg-slate-700 hover:shadow-xl hover:shadow-slate-100 dark:hover:shadow-slate-950/50">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-2xl bg-white dark:bg-slate-900 flex items-center justify-center text-[#4B98C8] shadow-sm shrink-0">
