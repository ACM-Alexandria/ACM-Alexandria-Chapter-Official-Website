...
const AboutSection = ({ 
  ...
  return (
    <section id="about" className="w-full py-24 px-6 relative overflow-hidden bg-gray-50/50 dark:bg-slate-900">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 
            ...
            data-aos="fade-up"
          >
            Leading the Future of <span className="text-[#205E85] dark:text-blue-300">Computing</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-24">
          ...
          <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-slate-950/40 border border-slate-100 dark:border-slate-700" data-aos="fade-left">
            ...
            <div className="mt-6 flex items-center gap-2">
              <span className="inline-block px-3 py-1 bg-[#4B98C8]/10 text-[#205E85] dark:text-blue-300 font-bold rounded-lg text-xs uppercase tracking-wider">
                Our Mission
              </span>
            </div>
          </div>
          ...
          <div className="mt-24">
            ...
            {loading ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="animate-pulse bg-slate-100 dark:bg-slate-800 rounded-3xl h-72 border border-slate-200/50 dark:border-slate-700" />
                ))}
              </div>
