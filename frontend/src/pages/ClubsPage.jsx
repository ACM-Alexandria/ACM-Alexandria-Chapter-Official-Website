...
import ClubCard from "../components/HomePage/cards/ClubCard";
import ClubDetailsSidebar from "../components/HomePage/ClubDetailsSidebar";
import Pagination from "../components/HomePage/Pagination";
import { fetchClubs } from "../services/homePageService";
...
const ClubsPage = () => {
    ...
    useEffect(() => {
        const load = async () => {
            ...
            setError(null);
            try {
                const data = await fetchClubs(currentPage);
    ...
    const handlePageChange = (pageIndex) => {
        ...
        window.location.href = `/clubs?page=${pageIndex + 1}`;
    };
                ...
                <div className="relative py-24 px-6 overflow-hidden bg-white">
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto text-center">
                        ...
                        >
                            ...
                            Find your place and grow with like-minded peers.
                        </p>
                    </div>
                </div>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
                                        {clubs.map((club, index) => (
                                            <ClubCard
                                                ...
                                                club={club}
                                                index={index}
                                                onShowDetails={handleShowClubDetails}
                                            />
                                        ))}
                                    </div>
